...
def read_data(predict_path):   
    ...
    return predictions
body_part_file      = "./BodyPart_Detection_geval_epoch_135.json"
causation_file      = "./Causation_Detection_geval_epoch_135.json"
coordination_file   = "./Coordination_Detection_geval_epoch_135.json"
error_file          = "./Error_Detection_geval_epoch_135.json"
method_file         = "./Method_Detection_geval_epoch_135.json"
time_file           = "./Time_Detection_geval_epoch_135.json"

body_part_file      = "./BodyPart_Detection_geval_instruction_by_GPT4-o"
causation_file      = "./Causation_Detection_geval_instruction_by_GPT4-o"
coordination_file   = "./Coordination_Detection_geval_instruction_by_GPT4-o"
error_file          = "./Error_Detection_geval_instruction_by_GPT4-o"
method_file         = "./Method_Detection_geval_instruction_by_GPT4-o"
time_file           = "./Time_Detection_geval_instruction_by_GPT4-o"

body_part_file      = "./BodyPart_Detection_geval_llama32_skating"
causation_file      = "./Causation_Detection_geval_llama32_skating"
coordination_file   = "./Coordination_Detection_geval_llama32_skating"
error_file          = "./Error_Detection_geval_llama32_skating"
method_file         = "./Method_Detection_geval_llama32_skating"
time_file           = "./Time_Detection_geval_llama32_skating"
